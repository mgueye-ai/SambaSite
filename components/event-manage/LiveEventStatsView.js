  ...
  return (
    <div className="evm-page">
      <header className="evm-lip">
        ...
        <span className="evm-lip-timer">{elapsed}</span>
      ...
      <div className="evm-body">
        ...
        <div className="evm-badge-row">
          <span className="evm-live-dot" />
          <span className="evm-badge evm-badge-live">Live</span>
          <span className="evm-badge-sub">· {elapsed} elapsed</span>
        </div>
